...
SKILL_LEVELS = ["SmallNovice", "Novice", "Expert"]
...
def get_subset_of_dataset(skill_level, sequence_type):
    ...
    **Later extensions:
    ...
    for dir in directories:
        ...
        t_series, timestamps = get_single_time_series_from_file(START_PATH + "\\" + skill_level + "Data" + "\\" + dir + "\\" + filename)
